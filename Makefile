...
HOSTCC = gcc
HOSTCFLAGS = -Wall -Wextra -Wshadow -Wstrict-prototypes  -g -O2
...
CXXFLAGS = -Wall -Wextra -Wshadow   -g -O2
PICFLAGS = -fPIC
LDFLAGS = -rdynamic  
CTARGETFLAGS = 
...
SMT = stat_dump_smt.o testpath.o expr_dump_smt.o expr_getname.o assign_dump_smt.o smt_generator.o
O = main.o async.o design_dump.o discipline.o dup_expr.o elaborate.o \
    ...
    PTask.o PUdp.o PWire.o Statement.o AStatement.o $M $(FF) $(TT) $(HH) $(SMT)

all: dep config.h _pli_types.h version_tag.h ivl version.exe iverilog-vpi.man
...
clean:
	...
	rm -f parse.output syn-rules.output dosify$(BUILDEXT) ivl check.vvp
