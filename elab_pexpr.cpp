 ...
 * expressions.
 */
NetExpr* PEConcat::elaborate_pexpr(Design*des, NetScope*scope) const
{
      NetExpr* repeat = 0;
...
NetExpr* PEString::elaborate_pexpr(Design*des, NetScope*scope) const
{
      return elaborate_expr(des, scope);
}

NetExpr* PETernary::elaborate_pexpr(Design*des, NetScope*scope) const
{
