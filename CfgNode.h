...
class CfgNode{
  public:
	...
	virtual void set_caseitem(svector<PExpr*> caseitem){caseitem_ = svector<PExpr*>(caseitem);};
	svector<PExpr*> get_caseitem(){return caseitem_;};
...
class BlockNode : public CfgNode {
  public:
	  ...
	  virtual void set_caseitem(svector<PExpr*> caseitem){nodes_[0]->set_caseitem(caseitem);};
...
class CaseNode : public CfgNode {
  public :
	...
	virtual void set_caseitem(svector<PExpr*> caseitem){paths_[0]->set_caseitem(caseitem);};
...
class CondNode : public CfgNode{
  public:
	...
	virtual void set_caseitem(svector<PExpr*> caseitem){root_->set_caseitem(caseitem);};
...
class EventNode : public CfgNode{
  public:
	...
	virtual void set_caseitem(svector<PExpr*> caseitem){root->set_caseitem(caseitem);};
