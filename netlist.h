...
class NetObj  : public Attrib, public virtual LineInfo {
    ...
    public:
    public:
	// The name of the object must be a perallocated string. A
	// lex_strings string, for example.
      ...
      void dump_node_pins_clp(ofstream&, unsigned) const;
      void dump_obj_attr_clp(ofstream&, unsigned) const;
...
class NetNode  : public NetObj {
	...
	// The name parameter must be a permallocated string.
      ...
      //virtual void dump_node_clp(ofstream&, unsigned) const;
...
class NetNet  : public NetObj {
	...
	/* Assignment statements count their lrefs here. */
      ...
      //virtual void dump_net_clp(ofstream&, unsigned, unsigned lineno) const;
...
class NetCLShift  : public NetNode {
    ...
    public:
      ...
      virtual void dump_node(ostream&, unsigned ind) const;
      //virtual void dump_node_clp(ofstream&, unsigned ind) const;
      //virtual bool emit_node(struct target_t*) const;
...
class NetMemory  {
	...
	// that are not zero based.
      ...
      //void dump_clp(ofstream&o, unsigned lm) const;
...
class NetExpr  : public LineInfo {
    public:
      ...
      virtual clp_var dump_cond_clp(ofstream&, unsigned lineno, set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr, unsigned temp_idx) const;
	  //virtual clp_var dump_expr_clp(ofstream&, unsigned lineno, set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr) const;
	...
	// for converting expressions to gates.
      ...
      //virtual set<RefVar*> get_vars() = 0;
	  //virtual string get_expr() = 0;
...
class NetEConst  : public NetExpr {
    ...
    public:
	  ...
	  virtual NetExpr* dup_expr() const;
      //virtual NetNet*synthesize(Design*);
      virtual NexusSet* nex_input();

      //virtual set<RefVar*> get_vars();
...
class NetSubnet  : public NetNet {
    ...
    public:
      ...
      virtual void dump_net(ostream&, unsigned) const;
      //virtual void dump_net_clp(ofstream&, unsigned, unsigned) const;
};
...
class NetProc : public virtual LineInfo {
	...
	// process. Most process types are not.
	  ...
	  */
      ...
      //virtual map<unsigned, condexpr*> BuildCExpr(unsigned);

      virtual void dump(ostream&, unsigned ind) const;

      virtual void dump_cond_clp(ofstream& o, unsigned lineno, set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr, bool result, int caseitemidx, unsigned temp_idx) const;
	  virtual void dump_expr_clp(ofstream& o, unsigned lineno, set<RefVar*>& refs, set<RefVar*>& lrefs, set<clp_var>& used, ostringstream& expr, bool result, int caseitemidx, unsigned temp_idx) const;
	  //virtual set<hname_t> get_refs() = 0;
	  //virtual set<hname_t> get_defs() = 0;
	  //virtual Net_CfgNode* build_node();
...
class NetAssign_ {
	...
	// This pointer is for keeping simple lists.
      ...
      clp_var dump_lval_clp(ofstream&o, unsigned lineno, set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr, unsigned temp_idx) const;
	  //set<hname_t> get_vars();
...
class NetAssignBase : public NetProc {
	...
	// This dumps all the lval structures.
      ...
      void dump_lval_clp(ofstream&o, unsigned lineno) const;

	  virtual void dump_expr_clp(ofstream& o, unsigned lineno, set<RefVar*>& refs, set<RefVar*>& lrefs, set<clp_var>& used, ostringstream& expr, bool result, int caseitemidx, unsigned temp_idx) const;
  	  virtual void dump_cond_clp(ofstream&o, unsigned lineno, set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr, unsigned temp_idx) const;

	  virtual void dump(ostream&, unsigned ind) const;
	  //virtual set<hname_t> get_refs();
	  //virtual set<hname_t> get_defs();
	  //virtual Net_CfgNode* build_node();
...
class NetAssign : public NetAssignBase {
    ...
    public:
      ...
      virtual int match_proc(struct proc_match_t*);
      virtual void dump(ostream&, unsigned ind) const;
      //virtual void dump_clp(ofstream&, unsigned ind, unsigned lineno) const;
	  virtual void dump_cond_clp(ofstream&o, unsigned lineno, set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr, unsigned temp_idx) const;
...
class NetBlock  : public NetProc {
	...
	// for sequential blocks.
      ...
      //virtual map<unsigned, condexpr*> BuildCExpr(unsigned count);
	  //virtual set<hname_t> get_refs();
	  //virtual set<hname_t> get_defs();
	  //virtual Net_CfgNode* build_node();
...
class NetTaskDef {
    ...
    public:
      ...
      //void dump_clp(ofstream&, unsigned ind, unsigned lineno) const;
...
class NetProcTop  : public LineInfo, public Attrib {
	...
	/* Create synchronous logic from this thread and return true,
	  ...
	  void dump_cond_clp(ofstream& o, unsigned lineno, set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr, bool result, int caseitemidx, unsigned temp_idx) const;
	  void dump_expr_clp(ofstream& o, unsigned lineno, set<RefVar*>& refs, set<RefVar*>& lrefs, set<clp_var>& used, ostringstream& expr, bool result, int caseitemidx, unsigned temp_idx) const;
...
class NetEConcat  : public NetExpr {
	...
	// Manipulate the parameters.
      void seti(unsigned idx, NetExpr*e);
      ...
      //virtual void expr_scan(struct expr_scan_t*) const;
      virtual void dump(ostream&) const;
      virtual clp_var dump_cond_clp(ofstream&, unsigned lineno, std::set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr, unsigned temp_idx) const;
...
class NetScope : public Attrib {
	...
	/* This method generates a hierarchical name that is
      ...
      void dump(ostream&) const;
      //void dump_clp(ofstream&, unsigned lineno) const;
...
class Design {
	...
	// PROCESSES
	  ...
	  NetProcTop* find_next_process(NetProcTop* npt);

	// Iterate over the design...
      void dump(ostream&) const;
      //void dump_cond_clp(ofstream& o, unsigned lineno, set<RefVar*>& refs, set<clp_var>& used, ostringstream& expr) const;
...
inline ofstream& operator << (ofstream&o, const NetExpr&exp)
{ /*exp.dump_cond_clp(o, exp.get_lineno());*/ return o; }

extern ofstream& operator << (ofstream&, NetNet::Type);

//extern int power(int base, int mi);
